...
<body>
    <div class="content">
        ...
        <div id="content">
            ...
            $query = "SELECT ID_Invite, Nom_Invite, Mail_Invite FROM invite order by Nom_Invite asc;";
            $result = $conn->query($query);
                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" name="emailte[]" id="emailTE" value="<?= (!$tuteur_entreprise) ? '' : $invite['Mail_Invite'] ?>" readonly>
                            </div>
                            <?php
                        } else {
