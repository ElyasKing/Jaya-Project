    ...
    <div class="content">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h2 class="center margin-title colored">Comptes</h2>
                <hr>
                <br>
                <br>
                <div class="panel" id="panel">
                            ...
                            <?php if (!empty($arr_users)) { ?>
                                <?php foreach ($arr_users as $user) { ?>
                                    <tr class="user-row">
                                        ...
                                        <td>
                                            <a href="admin/accountManagerUserUpdate_administrateur.php?id=<?= $user['Id_Utilisateur'] ?>">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a type="button" href="admin/accountManagerUserCreation_administrateur.php" class="btn me-md-3 btn-custom bg">Créer un compte</a>
                    </div>
